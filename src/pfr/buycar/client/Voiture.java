...
public class Voiture {
	...
	public String toString() {
		return "Voiture [reference=" + reference + ", marque=" + marque + ", modele=" + modele + ", annee=" + annee
				+ ", couleur=" + couleur + ", prix=" + prix + ", id_categorie=" + id_categorie + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		return annee == other.annee && Objects.equals(couleur, other.couleur) && id_categorie == other.id_categorie
				&& Objects.equals(marque, other.marque) && Objects.equals(modele, other.modele)
